...
export const resumeData: ResumeData = {
  ...
  education: [
    { examination: 'Graduation (B.Tech.)', university: 'IIT Bombay', institute: 'IIT Bombay', year: '2026 (Present)', grade: '8.01 CPI' },
    { examination: 'Intermediate', university: 'CBSE', institute: 'Vivekanand Sr Sec School', year: '2021', grade: '90.20%' },
    { examination: 'Matriculation', university: 'CBSE', institute: 'Vivekanand Sr Sec School', year: '2019', grade: '96.60%' },
  ],
  auxiliaryDegree: 'Pursuing dual Minor Degrees in Computer Science and Engineering and AI & Data Science',
  ...
  projects: [
    {
      ...
      technologies: ['Reinforcement Learning', 'Deep Q Networks', 'PPO', 'OpenAI Gym', 'ARIMA']
    },
    {
    ...
    },
    {
      ...
      technologies: ['TensorFlow', 'Keras', 'CNN', 'RNN', 'SRCNN', 'EDSR', 'MNIST', 'DIV2K']
    },
    {
      ...
      technologies: ['Analog Electronics', 'Op-amp', 'Phototransistor', 'Proportional Controller']
    },
    {
      ...
      technologies: ['PID Control', 'Arduino UNO', 'Optical Encoders', 'Ultrasonic Sensors', 'Servo Motors']
    },
    {
      ...
      technologies: ['Arduino Uno', 'HC-SR04', 'IR Sensors', 'L298N', 'Fusion 360']
    },
    {
      ...
      technologies: ['Python', 'Black-Scholes', 'Binomial Model', 'Monte Carlo Simulation']
    },
    {
  ...
  technicalSkills: [
    { name: 'Development & Simulation', skills: ['Python', 'C', 'C++', 'Arduino IDE', 'LATEX', 'Matlab', 'HTML', 'CSS', 'MS Office'] },
    { name: 'Libraries & Other Tools', skills: ['Numpy', 'Pandas', 'Matplotlib', 'Scikit-learn', 'Statsmodel', 'AutoDesk Fusion 360', 'Git'] },
  ],
  relevantCoursework: {
    Physics: ['Waves and Oscillations', 'Thermal Physics', 'Quantum Mechanics', 'Classical Mechanics', 'Statistical physics', 'Quantum Mechanics II'],
    Mathematics: ['Calculus I and II', 'Linear Algebra', 'Differential Equations I', 'Complex Analysis', 'Integral Transforms', 'Numerical Analysis'],
    'CS & Electronics': ['Computer Programming and Utilisation', 'Logic For Computer Science', 'Makerspace (introducing the Mechanical and Electrical aspects of engineering)', 'Analog Electronics', 'Digital Electronics and Microprocessors'],
    'Data Science': ['AI and Data Science', 'Introduction to Machine Learning'],
    HASMED: ['Introduction to Entrepreneurship', 'Introduction to The Arts', 'Economics', 'Design thinking for innovation'],
  },
  extracurriculars: {
    Competitions: [
